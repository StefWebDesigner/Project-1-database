...
insert into users(userid, firstname,lastname, username, password, city, state, email,accountType, post) 
 ...
 insert into users(userid, firstname,lastname, username, password, city, state, email,accountType, post) 
 values (01139, 'Chirstian','Pulisic','pulisic','password7', 'Hershey', 'Pennsylvania', 'captainAmerica@usa.com', 'user', 10 );
...
values('Super fun activity', 'bicking is super fun Therefore I would to bick very often', 'Activity');


insert into category(title, mainbodycontent, genreCategory)
values('Super delicious food', 'A pizza at Tuta Bella is so delicious  that I want to eat it  very often', 'Food');
